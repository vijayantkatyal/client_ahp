										...
										<tr>
											...
											<td>
												<div class="btn-list flex-nowrap">
													<a href="{{ route('get_admin_school_event_edit', ['id' => $event->id]) }}" class="btn btn-white">
														Edit
													</a>
													<div class="dropdown">
														...
														<div class="dropdown-menu dropdown-menu-end">
															...
															<form id="delete-user-{{ $event->id }}" action="{{ route('post_admin_school_event_delete', ['id' => $event->id]) }}" method="POST" style="display: none;">
																{{ csrf_field() }}
															</form>
														</div>
													</div>
	...
	<div class="modal modal-blur fade" id="modal-new-user" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<form action="{{ route('post_admin_school_event') }}" method="POST">
					{{ csrf_field() }}
					<div class="modal-body">
						...
						<div class="mb-3">
							...
							<textarea name="description" placeholder="Description" class="form-control" rows="3" id=""></textarea>
						</div>
