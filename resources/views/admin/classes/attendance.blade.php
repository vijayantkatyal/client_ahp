			...
			<div class="row align-items-center">
				...
				<div class="col-auto ms-auto d-print-none">
					<div class="d-flex">
						...
						<a href="{{ route('get_admin_download_report_pdf_m_student', ['cid' => $class->id]) }}?range={{ $range }}" class="btn btn-primary me-1" title="download attendance of all students">
							<svg style="margin: 0;" xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-file-type-pdf"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M5 12v-7a2 2 0 0 1 2 -2h7l5 5v4" /><path d="M5 18h1.5a1.5 1.5 0 0 0 0 -3h-1.5v6" /><path d="M17 18h2" /><path d="M20 15h-3v6" /><path d="M11 15v6h1a2 2 0 0 0 2 -2v-2a2 2 0 0 0 -2 -2h-1z" /></svg>
						</a>
						<a href="{{ route('get_admin_download_report_excel_m_student', ['cid' => $class->id]) }}?range={{ $range }}" class="btn btn-primary" title="download attendance of all students">
								...
								<tbody>
									@foreach($students as $user)
										<tr>
                                            ...
                                            @endforeach
											<td class="text-end">
												<a href="{{ route('get_admin_download_report_pdf_student', ['uid' => $user->id, 'cid' => $class->id]) }}?range={{ $range }}" class="btn btn-outline-primary" title="download attendance of selected student"><svg style="margin: 0;" xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-file-type-pdf"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M5 12v-7a2 2 0 0 1 2 -2h7l5 5v4" /><path d="M5 18h1.5a1.5 1.5 0 0 0 0 -3h-1.5v6" /><path d="M17 18h2" /><path d="M20 15h-3v6" /><path d="M11 15v6h1a2 2 0 0 0 2 -2v-2a2 2 0 0 0 -2 -2h-1z" /></svg></a>
												<a href="{{ route('get_admin_download_report_excel_student', ['uid' => $user->id, 'cid' => $class->id]) }}?range={{ $range }}" class="btn btn-outline-primary" title="download attendance of selected student"><svg style="margin: 0;" xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-file-spreadsheet"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /><path d="M8 11h8v7h-8z" /><path d="M8 15h8" /><path d="M11 11v7" /></svg></a>
											</td>
										</tr>
									@endforeach
								</tbody>
