		...
		<div class="page-header d-print-none">
			<div class="row align-items-center">
				...
				<div class="col-auto ms-auto d-print-none">
					<div class="d-flex">
						<form style="display: inline-flex;" action="{{ route('get_admin_staff_class_attendance', $class->id) }}" method="get">
							...
							@if($range != null)
								<a class="btn btn-info me-1" href="{{ route('get_admin_staff_class_attendance', $class->id) }}" title="Reset Filter and show all data">Reset</a>
							@endif
						</form>
